...
def parse_aspect_polarity(atsa_seq, sentence):
    ...
    def parse_seq(aspect_polarity):
        ...
        if 'aspect_term' not in aspect_polarity or 'sentiment' not in aspect_polarity:
            return False

        aspect = aspect_polarity['aspect_term']
        polarity = aspect_polarity['sentiment']
    ...
    print('aspect_polarity_list:', aspect_polarity_list)
    ...
    print('final aspect_polarity_list:', aspect_polarity_list)
...
def parse_aspect_polarity_for_true(atsa_seq, sentence):
    ...
    for sub_seq in atsa_seq:
        ...
        aspect_polarity_list.append(tuple([sub_seq['aspect_term'], sub_seq['sentiment']]))
